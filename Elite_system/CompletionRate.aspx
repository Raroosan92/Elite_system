<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="CompletionRate.aspx.cs" Inherits="Elite_system.CompletionRate" %>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr style="background-color: #2f323a;">
                                ...
                                <td style="width: 98px">
                                    <asp:Label ID="Label3" runat="server" Text="كشف نسبة الإنجاز في العمل" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style1">
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="DDL_Employee"
                                        CssClass="alertFont" ErrorMessage="الرجاء اختيار الموظف" Operator="NotEqual"
                                        ValueToCompare="0" Display="Dynamic" ForeColor="Red" Font-Bold="true">الرجاء اختيار الموظف</asp:CompareValidator>
                                    <asp:DropDownList ID="DDL_Employee" runat="server" DataTextField="Employee_Name" DataValueField="ID" Width="270px">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 98px">
                            ...
                            <tr>
                                <td class="auto-style1"></td>
                                <td style="width: 98px">
                                    <asp:Button ID="Btn_Search" runat="server" Text="بحث" Height="28px" Width="152px" OnClick="Btn_Search_Click" />
                                </td>
                            </tr>
