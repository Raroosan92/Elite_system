<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="DeliveredChecks.aspx.cs" Inherits="Elite_system.DeliveredChecks" %>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" cellpadding="3" border="0" style="width: 97%; float: right; margin-right: 3%; max-width: 100%; margin-bottom: 20px;">
                                    <tr style="background-color: #2f323a;">
                                        <td style="width: 98px">
                                            <asp:Label ID="Label2" runat="server" Text="تسليم الشيكات" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="Btn_Save2" runat="server" Text="تسليم عن طريق رقم الشيك" Height="26px" OnClick="Btn_Save2_Click" />
