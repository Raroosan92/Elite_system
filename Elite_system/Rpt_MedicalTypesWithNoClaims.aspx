<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Rpt_MedicalTypesWithNoClaims.aspx.cs" Inherits="Elite_system.Rpt_MedicalTypesWithNoClaims" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr style="background-color: #2f323a;">
                                ...
                                <td style="width: 98px">
                                    <asp:Label ID="Label3" runat="server" Text=" كشف الجهات الطبية التي لم يتم استلام مطالباتها" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style1">
                                    <asp:TextBox AutoCompleteType="Disabled" ID="Txt_FromDate" runat="server" Width="120px"></asp:TextBox>
                            ...
                            <tr>
                                <td class="auto-style1">
                                    <asp:TextBox AutoCompleteType="Disabled" ID="Txt_ToDate" runat="server" Width="120px"></asp:TextBox>
                            ...
                            <tr>
                                <td class="auto-style1">
                                    <asp:DropDownList runat="server" ID="DDL_Region" DataTextField="Description" DataValueField="ID" Width="300px"></asp:DropDownList>
                                </td>
                                <td style="width: 98px">

                                    <asp:Label ID="Label2" runat="server" Text="المنطقة "></asp:Label></td>
    ...
    <section class="text-center Report" style="padding-top: 1%; direction: ltr;">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="600px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="800px">
            <LocalReport ReportPath="Rpt_MedicalTypesWithNoClaims.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DS_Rpt_MedicalTypesWithNoClaims" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="Elite_system.DS_Rpt_MedicalTypesWithNoClaimsTableAdapters.V_Get_MedicalTypesWithNoClaimsTableAdapter"></asp:ObjectDataSource>
    </section>
