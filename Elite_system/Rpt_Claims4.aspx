<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Rpt_Claims4.aspx.cs" Inherits="Elite_system.Rpt_Claims4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr style="background-color: #2f323a;">
                                ...
                                <td style="width: 98px">
                                    <asp:Label ID="Label3" runat="server" Text=" كشف المطالبات حسب الشركة" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:DropDownList ID="DDL_Main_Company" runat="server" DataTextField="Name" DataValueField="ID" Width="270px">
                                    </asp:DropDownList>
                                </td>
                                <td>
    ...
    <section class="text-center Report" style="padding-top: 1%; direction: ltr;">
        ...
        <rsweb:ReportViewer CssClass="Report" ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="524px">
