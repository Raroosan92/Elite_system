<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Bond_StartDate.aspx.cs" Inherits="Elite_system.Bond_StartDate" %>
                                ...
                                <table class="table table-striped">
                                    <tr style="background-color: #2f323a;">
                                        ...
                                        <td style="width: 98px">
                                            ...
                                            <asp:Label ID="Label3" runat="server" Text="رصيد بداية المدة" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                        </td>
                                    </tr>
                        ...
                        <div class="COLR">
                            <div class="table-responsive" style="height: 500px;">
                                <table class="table-responsive">
                                    ...
                                    <asp:SqlDataSource runat="server" ID="SqlDataSource_Receipt" ConnectionString='<%$ ConnectionStrings:CONN %>' SelectCommand="SELECT ID, Medical_TypeName, TypeDescription, Bond_Date, Debtor, Creditor, Description, Claim_ID FROM V_Listing_Bonds WHERE (Type = 332) ORDER BY ID DESC"></asp:SqlDataSource>
                                    <asp:GridView ID="GridView_receipt" runat="server" CssClass="Grid" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSource_Receipt" OnSelectedIndexChanged="GridView_receipt_SelectedIndexChanged">
                                        <Columns>
