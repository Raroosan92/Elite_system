<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Rpt_Claims2.aspx.cs" Inherits="Elite_system.Rpt_Claims2" %>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr style="background-color: #2f323a;">
                                        ...
                                        <td style="width: 98px">
                                            <asp:Label ID="Label3" runat="server" Text=" كشف المطالبات حسب الجهة الطبية" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                        </td>
                                    </tr>
                            <tr>
