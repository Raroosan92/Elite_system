<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Rpt_Stamps.aspx.cs" Inherits="Elite_system.Rpt_Stamps" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr style="background-color: #2f323a;">
                                ...
                                <td style="width: 98px">
                                    <asp:Label ID="Label3" runat="server" Text=" كشف طوابع الشركات " ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><asp:Label runat="server" Text="الشركة"></asp:Label>
                                   
                                </td>
                            </tr>
                              <tr>
                                <td>
                                    <asp:DropDownList ID="DDL_Main_Medical" runat="server" DataTextField="Name" DataValueField="ID" Width="300px">
                                    </asp:DropDownList>
                                </td>
                                <td>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function jsFunctions() {
            ...
            $("#<%=DDL_Main_Medical.ClientID%>").select2();
        }
