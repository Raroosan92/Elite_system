...
{
    public partial class RefundedMail : System.Web.UI.Page
    {
        ...
        protected void Btn_Save1_Click(object sender, EventArgs e)
        {
            ...
            if (Refunded > 0)
            {
                MSG("لقد تم إرجاع هذا البريد مسبقا");
                return;
            }
            int Delivered = 0;
            ...
            if (Result == true)
            {
                ...
                log._Log_Event = " إرجاع البريد رقم الباركود  : " + Txt_BarCode.Text;
                log.Insert_Log();
                ////////////////////////////////   End Of Log        /////////////////////////////////////////////
        ...
        //        ////////////////////////////////       Log        /////////////////////////////////////////////
        //        Cls_Log log = new Cls_Log();
        //        log._Log_Event = " إرجاع البريد رقم   : " + Txt_CheckNo.Text;
        //        log.Insert_Log();
        //        ////////////////////////////////   End Of Log        /////////////////////////////////////////////
        ...
        protected void GV_ChecksAssigned_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "UPDATE [dbo].[Main_Mail] SET [Refunded] = " + 0 + ",Modified= '" + dt1 + "' WHERE BarCode = '" + GV_ChecksAssigned.Rows[0].Cells[11].Text + "'";
                Cls_Connection.open_connection();
                cmd.ExecuteNonQuery();
            ...
            ////////////////////////////////       Log        /////////////////////////////////////////////
            Cls_Log log = new Cls_Log();
            log._Log_Event = " تراجع عن إرجاع البريد رقم الباركود   : " + GV_ChecksAssigned.Rows[0].Cells[6].Text;
            log.Insert_Log();
            ////////////////////////////////   End Of Log        /////////////////////////////////////////////
            Get_MainChecks_ForGridView();
        }
        ...
        public void Get_MainChecks_ForGridView()
        {
            try
            {
                ...
                cmd.CommandText = "Get_MainMail_AssignMail6";
        ...
        //        SqlCommand cmd = new SqlCommand();
        //        cmd.Connection = con;
        //        cmd.CommandText = "select * from V_Main_Mail where Check_No = '" + Txt_BarCode.Text + "'";
        //        Cls_Connection.open_connection();
