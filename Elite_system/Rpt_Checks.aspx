<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Rpt_Checks.aspx.cs" Inherits="Elite_system.Rpt_Checks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <td style="width: 98px">
                                    ...
                                    <asp:Label ID="Label2" runat="server" Text="حالة الشيك"></asp:Label></td>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" CssClass="Report" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="135%" Height="100%" >
