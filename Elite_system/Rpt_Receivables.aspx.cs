...
{
    public partial class Rpt_Receivables : System.Web.UI.Page
    {
        ...
        public void Result_DT()
        {
            try
            {
                ...
                if (HttpContext.Current.User.IsInRole("Admin"))
                {
                    cmd.CommandText = "Get_V_Receivables_Report";
                }
                else
                {
                    cmd.CommandText = "Get_V_Receivables_Report";
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("Rpt_Receivables.rdlc");
                ...
                ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DS_Receivables", dt_Result));
