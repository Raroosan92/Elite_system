...
namespace Elite_system
{
    public partial class RefundedCheckes : System.Web.UI.Page
    {
        ...
        public void SaveAssignCheckedToTempTable()
        {
            ...
            {
                MSG("هذا الشيك تم إرجاعه مسبقاً");
            }
        }
            ...
            try
            {
                ...
                if (Exist == 1)
                {
                    if (empname != "")
                    {
                        ...
                        cmd.CommandText = "UPDATE [dbo].[Main_Check] SET [Refunded] = " + 1 + ",Delivered=" + 0 + ",Modified= "+ DateTime.UtcNow + " WHERE BarCode = '*" + Txt_BarCode.Text + "*'";
                        Cls_Connection.open_connection();
                        cmd.ExecuteNonQuery();
                        Cls_Connection.close_connection();
                        Result = true;
        ...
        public void SaveAssignNameToChecked2()
        {
            try
            {
                ...
                if (Exist == 1)
                {
                    ...
                    {
                        //To Update Name in checkes
                        cmd.CommandText = "UPDATE [dbo].[Main_Check] SET  Refunded= " + 1 + ",[Delivered] =" + 0 + ",Modified= " + DateTime.UtcNow + " WHERE Check_No = '" + Txt_CheckNo.Text + "'";
                        Cls_Connection.open_connection();
                        cmd.ExecuteNonQuery();
                        Cls_Connection.close_connection();
                        Result = true;
                ...
                else if (Exist > 1)
                {
                    ...
                    else
                    {
                        ...
                        {
                            //To Update Name in checkes
                            cmd.CommandText = "UPDATE [dbo].[Main_Check] SET [Delivered] = " + 0 + ",Refunded=" + 1 + ",Modified= " + DateTime.UtcNow + " WHERE Check_No = '" + Txt_CheckNo.Text + "' and Sent_To=" + long.Parse(DDL_Sent_To.SelectedValue);
                            Cls_Connection.open_connection();
                            cmd.ExecuteNonQuery();
                            CheckMore = true;
                            Cls_Connection.close_connection();
        ...
        protected void Btn_Save1_Click(object sender, EventArgs e)
        {
            ...
            if (Refunded > 0)
            {
                MSG("لقد تم إرجاع هذا الشيك مسبقا");
                return;
            }
            ...
            if (Result == true)
            {
                ...
                log._Log_Event = " إرجاع الشيك رقم الباركود  : " + Txt_BarCode.Text;
                log.Insert_Log();
                ////////////////////////////////   End Of Log        /////////////////////////////////////////////
        ...
        protected void Btn_Save2_Click(object sender, EventArgs e)
        {
            ...
            if (Result == true)
            {
                ////////////////////////////////       Log        /////////////////////////////////////////////
                Cls_Log log = new Cls_Log();
                log._Log_Event = " إرجاع الشيك رقم   : " + Txt_CheckNo.Text;
                log.Insert_Log();
                ////////////////////////////////   End Of Log        /////////////////////////////////////////////
        ...
        protected void GV_ChecksAssigned_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "UPDATE [dbo].[Main_Check] SET [Refunded] = " + 0 + ",Modified= " + DateTime.UtcNow + " WHERE BarCode = '" + GV_ChecksAssigned.Rows[0].Cells[12].Text + "'";
                Cls_Connection.open_connection();
                cmd.ExecuteNonQuery();
            ...
            ////////////////////////////////       Log        /////////////////////////////////////////////
            Cls_Log log = new Cls_Log();
            log._Log_Event = " تراجع عن إرجاع الشيك رقم الباركود   : " + GV_ChecksAssigned.Rows[0].Cells[12].Text;
            log.Insert_Log();
            ////////////////////////////////   End Of Log        /////////////////////////////////////////////
            Get_MainChecks_ForGridView();
        }
