<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Rpt_Listing1.aspx.cs" Inherits="Elite_system.Rpt_Listing1" %>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr style="background-color: #2f323a;">
                                ...
                                <td style="width: 98px">
                                    <asp:Label ID="Label3" runat="server" Text=" كشف السندات" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                </td>
                            </tr>
                             ...
                             <tr>
                                        <td>
                                            ...
                                            <asp:DropDownList runat="server" ID="DDL_Type" Width="270px" DataTextField="Description" DataValueField="ID" ></asp:DropDownList>
                                        </td>
                                        <td>
