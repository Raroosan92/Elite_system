<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Rpt_Claims3.aspx.cs" Inherits="Elite_system.Rpt_Claims3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr style="background-color: #2f323a;">
                                ...
                                <td style="width: 98px">
                                    <asp:Label ID="Label3" runat="server" Text=" كشف التدقيق حسب الجهة الطبية" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <asp:DropDownList ID="DDL_Main_Company" runat="server" AutoPostBack="True" DataTextField="Name" DataValueField="ID" OnSelectedIndexChanged="DDL_Main_Company_SelectedIndexChanged" Width="220px">
                                    </asp:DropDownList>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:DropDownList ID="DDL_Sub_Company" runat="server" Width="220px" DataTextField="Sub_Company" DataValueField="ID">
                                    </asp:DropDownList>
                                </td>
                                <td>
    ...
    <section class="text-center Report" style="padding-top: 1%; direction: ltr;">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" CssClass="Report" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="700px" Height="500px">
        </rsweb:ReportViewer>
