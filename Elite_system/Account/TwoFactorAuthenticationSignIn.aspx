<%@ Page Title="Two-Factor Authentication" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TwoFactorAuthenticationSignIn.aspx.cs" Inherits="Elite_system.Account.TwoFactorAuthenticationSignIn" %>
    ...
    <asp:PlaceHolder runat="server" ID="verifycode" Visible="false">
        <section>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="Code" CssClass="form-control" />
                </div>
            </div>
            <div class="form-group">
