<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="RefundedMail.aspx.cs" Inherits="Elite_system.RefundedMail" %>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" cellpadding="3" border="0" style="width: 97%; float: right; margin-right: 3%; max-width: 100%; margin-bottom: 20px;">
                                    <tr style="background-color: #2f323a;">
                                        <td style="width: 98px">
                                            <asp:Label ID="Label2" runat="server" Text="إرجاع البريد" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                        </td>
                                   ...
                                   <%-- <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%--<asp:Button ID="Btn_Save2" runat="server" Text="إرجاع عن طريق رقم البريد" Height="26px" OnClick="Btn_Save2_Click" />--%>
