<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="DeliveredMail.aspx.cs" Inherits="Elite_system.DeliveredMail" %>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" cellpadding="3" border="0" style="width: 97%; float: right; margin-right: 3%; max-width: 100%; margin-bottom: 20px;">
                                    <tr style="background-color: #2f323a;">
                                        <td style="width: 98px">
                                            <asp:Label ID="Label2" runat="server" Text="تسليم البريد" ForeColor="#f2f2f2" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                        </td>
                                 ...
                                 <%--   <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Button ID="Btn_Save1" runat="server" Text=" تسليم عن طريق البار كود" Height="26px" OnClick="Btn_Save1_Click" />

                                        </td>
                                        <td>
                                            <%--<asp:Button ID="Btn_Save2" runat="server" Text="تسليم عن طريق رقم البريد" Height="26px" OnClick="Btn_Save2_Click" />--%>
                            ...
                            <div class="table-responsive" style="overflow-x: initial !important; margin-right: 59px;">
                                <table class="table-responsive" style="overflow-x: initial !important; margin-right: 59px;">
                                    <asp:GridView ID="GV_ChecksAssigned" Width="225%" runat="server" AllowPaging="false" CssClass="Grid" OnSelectedIndexChanged="GV_ChecksAssigned_SelectedIndexChanged">
                                        <Columns>
                                            <asp:CommandField ShowSelectButton="True" SelectText="تراجع" ItemStyle-ForeColor="Black" />
                                        </Columns>
                                    </asp:GridView>
                                </table>
